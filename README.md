...
This data is derived from [Overture Maps](https://overturemaps.org/) (CDLA) and [Mapillary](https://www.mapillary.com/) (CC BY-SA). OpenStreetMapdata was used in the aerial imagery to POI boulnding boxes [OpenStreetMap](https://opensrteetmap.org/) (OdBL) Embeddings and visual descriptions were generated by [zephr-maps](https://github.com/zephr-xyz/zephr-maps) pipeline.
